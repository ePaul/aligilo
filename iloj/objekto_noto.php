...
function listu_notojn($ppID, $kapteksto="") {
     ...
     *           identigilo por la sercxilo-objekto (uzata por ordigoj).
     *            ne estu la sama kiel por aliaj sercxoj sur la sama
     *            pagxo.
     * @param boolean $kunPartoprenanto se true, ni ankaux montras la
     ...
     *       - cxiuj:          montru cxiujn, sendepende de
     *                             prilaboro-stato.
     * @param int $porEntajpanto se ne 0, montras nur tiajn notojn, kiuj estas
     *                 por la indikita entajpanto.
     * @param int $aldona_kondicxo se ne "", aldona kondicxo por la elekto.
     */
