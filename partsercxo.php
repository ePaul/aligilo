<?php
  ...
  /**
   * Serĉado de partoprenantoj.
   *
   * Kaj serĉ-formularo (fakte du: simpla/ĝenerala)
   * kaj montrilo por rezultolisto de la simpla serĉo.
   * Krome enestas ligoj al spezialigitaj serĉoj (kaj
   * la detala serĉo).
   *
